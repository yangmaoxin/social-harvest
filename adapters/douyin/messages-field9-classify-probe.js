import {
  ...
  probeDouyinPrivateMessageField9Classification,
} from './shared.js';
...
export const douyinMessagesField9ClassifyProbeSpec = {
  site: 'douyin',
  name: 'skill-messages-field9-classify-probe',
  description: '分类抖音私信候选 field 9 值的脱敏形态，不输出正文或原始响应',
  args: [
...
if (cli && Strategy) {
  cli({
    site: 'douyin',
    name: 'skill-messages-field9-classify-probe',
    description: douyinMessagesField9ClassifyProbeSpec.description,
    access: 'read',
    ...
    defaultFormat: 'json',
    timeoutSeconds: 240,
    args: douyinMessagesField9ClassifyProbeSpec.args,
    columns: douyinMessagesField9ClassifyProbeSpec.columns,
    func: async (page, kwargs) => probeDouyinPrivateMessageField9Classification(page, kwargs),
  });
}
